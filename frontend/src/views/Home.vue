  ...
  <div class="home-container animate-fade-in">
    ...
    <section class="hero-section">
      <div class="hero-content">
        ...
        <p class="hero-subtitle">
          Khám phá hệ thống lắp ráp PC đầu tiên tại Việt Nam tích hợp AI kiểm tra tương thích thời gian thực. Bắt đầu hành trình build máy ước mơ của bạn ngay hôm nay.
        </p>
        
        <div class="cta-group">
          <button @click="startBuilding" class="btn btn-primary cta-btn build-btn">
    ...
    <section class="features-grid">
      <div class="feature-card glass-panel">
        ...
        <p>Hệ thống tự động loại bỏ các linh kiện không phù hợp với Socket, kích thước hoặc công suất nguồn.</p>
      </div>
      <div class="feature-card glass-panel">
        <div class="f-icon"><Zap :size="24" /></div>
        <h3>Hiệu năng Tối ưu</h3>
        <p>Đề xuất cấu hình cân bằng nhất dựa trên ngân sách và nhu cầu sử dụng của bạn.</p>
      </div>
      <div class="feature-card glass-panel">
        <div class="f-icon"><ShieldCheck :size="24" /></div>
        <h3>Bảo hành 1-đổi-1</h3>
        <p>Chúng tôi cam kết chất lượng linh kiện chính hãng với chế độ bảo hành vàng cho mọi bộ máy.</p>
      </div>
    </section>
    ...
    <section class="featured-products">
      <div class="section-header">
        <h2 class="section-title">Linh kiện <span class="gradient-text">Mới nhất</span></h2>
        <RouterLink to="/products" class="view-all">Xem tất cả <ArrowRight :size="16"/></RouterLink>
      </div>
    ...
    <section class="workflow-section glass-panel">
      <div class="workflow-content">
        <h2 style="font-size: 2.2rem; margin-bottom: 32px;">Quy trình tạo nên <span class="gradient-text">Kiệt tác</span></h2>
        <div class="steps">
          <div class="step">
        ...
        <button @click="startBuilding" class="btn btn-primary" style="margin-top: 40px; width: 240px; height: 56px;">Bắt đầu lắp ngay</button>
      </div>
    </section>
  </div>
</template>
...
.floating-badge.bottom { bottom: 60px; left: -20px; animation: float 6s infinite ease-in-out reverse; }
...
/* Featured Products */
.featured-products { margin-bottom: 120px; }
.section-header { display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 40px; }
.section-title { font-size: 2.8rem; font-weight: 800; }
.view-all { color: var(--accent-primary); text-decoration: none; font-weight: 700; display: flex; align-items: center; gap: 8px; }
...
.step h4 { font-size: 1.25rem; font-weight: 700; margin-bottom: 12px; }
