...
const validateAccountForm = () => {
  ...
  const hasCurrentPassword = !!String(
  ...
  if (hasNewPassword) {
    ...
    if (
      accountForm.value.password !== accountForm.value.password_confirmation
    ) {
...
const submitAddress = async () => {
  ...
  try {
    const payload = {
      ...
      ward:
        String(addressForm.value.ward || "").trim() ||
        String(addressForm.value.district || "").trim(),
    ...
    closeAddressForm();
    toastStore.success(
      editingAddressId.value ? "Đã cập nhật địa chỉ." : "Đã thêm địa chỉ mới.",
    );
  } catch (err) {
  ...
  <div class="profile-view animate-fade-in">
      ...
      <main class="profile-main">
          ...
          <div v-else class="orders-list">
            <article v-for="order in orders" :key="order.id" class="order-card">
              ...
              <footer class="order-footer">
                ...
                >
                <button class="btn btn-sm" @click="openOrderDetail(order.id)">
                  Chi tiết
                </button>
              </footer>
            </article>
        ...
        <section v-if="activeTab === 'addresses'" class="panel glass-panel">
          <div class="panel-head">
            ...
            <button class="btn btn-sm" @click="showCreateAddressForm">
              Thêm địa chỉ
            </button>
          </div>

          <div v-if="addressesLoading" class="state-msg">
            Đang tải địa chỉ...
          </div>
          <div v-else-if="addresses.length === 0" class="state-msg">
          ...
          <div v-else class="address-list">
            ...
            >
              <header class="address-head">
                ...
                <span v-if="addr.is_default" class="default-pill"
                  >Mặc định</span
                >
              </header>
              ...
              <div class="address-actions">
                <button class="btn btn-sm" @click="showEditAddressForm(addr)">
                  Sửa
                </button>
                <button
                  class="btn btn-sm"
                ...
                <button class="btn btn-sm danger" @click="removeAddress(addr)">
                  Xóa
                </button>
              </div>
            </article>
            ...
            <div class="form-grid">
              <div>
                <input
                  ...
                  @input="clearAddressFieldError('recipient_name')"
                />
                <p v-if="addressErrors.recipient_name" class="field-error">
              ...
              <div>
                <input
                  ...
                  @input="clearAddressFieldError('phone')"
                />
                <p v-if="addressErrors.phone" class="field-error">
                  {{ addressErrors.phone }}
                </p>
              </div>
              <div>
              ...
              <div>
                <input
                  ...
                  @input="clearAddressFieldError('line1')"
                />
                <p v-if="addressErrors.line1" class="field-error">
                  {{ addressErrors.line1 }}
                </p>
              </div>
              <div>
              ...
              <div>
                <input
                  ...
                  @input="clearAddressFieldError('district')"
                />
                <p v-if="addressErrors.district" class="field-error">
              ...
              <div>
                <input
                  ...
                  @input="clearAddressFieldError('province')"
                />
                <p v-if="addressErrors.province" class="field-error">
                  {{ addressErrors.province }}
                </p>
              </div>
              <label class="default-toggle">
                <input v-model="addressForm.is_default" type="checkbox" /> Đặt
                làm mặc định
              </label>
            </div>
        ...
        <section v-if="activeTab === 'account'" class="panel glass-panel">
          ...
          <div class="form-grid">
            <div>
              ...
              />
              <p v-if="accountErrors.name" class="field-error">
                {{ accountErrors.name }}
              </p>
            </div>
            <div>
              <input
                ...
                placeholder="Email"
                @input="clearAccountFieldError('email')"
              />
              <p v-if="accountErrors.email" class="field-error">
                {{ accountErrors.email }}
              </p>
            </div>
            <div>
              <input
                ...
                @input="clearAccountFieldError('current_password')"
              />
              <p v-if="accountErrors.current_password" class="field-error">
            ...
            <div>
              <input
                ...
                @input="clearAccountFieldError('password')"
              />
              <p v-if="accountErrors.password" class="field-error">
            ...
            <div>
              <input
                ...
                @input="clearAccountFieldError('password_confirmation')"
              />
              <p v-if="accountErrors.password_confirmation" class="field-error">
          ...
          <div class="form-actions">
            <button
              ...
              @click="saveAccount"
            >
              {{ accountSaving ? "Đang cập nhật..." : "Lưu thông tin" }}
            </button>
          </div>
        </section>
      </main>
    ...
    >
      <div class="modal-content glass-panel">
        ...
        <div v-if="orderDetailLoading" class="state-msg">
        ...
        <div v-else>
          <div class="detail-grid">
            ...
            <div>
              ...
              {{ formatPrice(selectedOrder.subtotal_cents) }}
            </div>
            <div>
              <strong>Phí ship:</strong>
              {{ formatPrice(selectedOrder.shipping_cents) }}
            </div>
            <div>
              <strong>Thuế:</strong> {{ formatPrice(selectedOrder.tax_cents) }}
            </div>
            <div>
              <strong>Tổng:</strong>
